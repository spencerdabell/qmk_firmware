...
[_NV] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,             _______, C(KC_Y), C(KC_PGUP), KC_PGDN, KC_PGUP, C(KC_PGDN), _______, _______, _______,
        ...
        _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______,            _______,C(KC_HOME),C(KC_LEFT), KC_WH_D, KC_WH_U, C(KC_RGHT), C(KC_END), _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[_MS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
