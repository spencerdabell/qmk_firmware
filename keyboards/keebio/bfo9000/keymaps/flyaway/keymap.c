...
_______, TG(_NAVI),CT(KC_A),GT(KC_S),AT(KC_D),LT(_NAVI, KC_F),LT(_MOUS,KC_G),_______,_______,   _______, KC_H,    KC_J,    AT(KC_K),KC_L, CT(KC_SCLN),KC_QUOT, KC_ENT , _______,
        ...
        _______, LT(_MUSE,KC_MPLY),KC_MPRV,KC_MNXT,_______,KC_TAB,ST(KC_ENT),KC_DEL,_______,    KC_BSPC, ST(KC_SPC),KC_TAB,_______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
),
[_NAVI] = LAYOUT(
        ...
        _______, _______, KC_LCTL, KC_LGUI, KC_LALT, _______, _______, _______, _______,        _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______, _______, _______,
        ...
        _______, _______, _______, _______, _______, KC_LSFT, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[_MOUS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_MUSE] = LAYOUT(
        ...
        _______, _______, KC_MUTE, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[_FUNC] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
