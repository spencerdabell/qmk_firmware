...
[L_BS] = LAYOUT(
        ...
        _______, KC_DEL,CT(KC_A),AT(KC_S),    GT(KC_D),LT(L_NV,KC_F),   KC_G,    _______, _______,        _______,    KC_H,    KC_J,      GT(KC_K),AT(KC_L),CT(KC_SCLN),KC_QUOT, _______, _______,
        _______, TO(L_BS), KC_Z,    KC_X,        KC_C, LT(L_MS,KC_V),   KC_B,    _______, _______,        _______,    KC_N,    KC_M,         KC_COMM, KC_DOT,  KC_SLSH, _______, _______, _______,
_______,LT(L_SD,KC_MPLY), KC_MPRV,KC_MNXT,_______,LT(L_FN,KC_TAB),ST(KC_ENT),LT(L_SY, KC_DEL),_______,    KC_BSPC, ST(KC_SPC),LT(L_SY,KC_GRV),_______, TO(L_NV), TO(L_BS), TO(L_GAME), _______, _______
),
[L_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
