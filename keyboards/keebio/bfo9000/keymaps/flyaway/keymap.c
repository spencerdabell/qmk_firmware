...
#define WN_LEFT LCTL(LGUI(KC_LEFT))
#define WN_RGHT LCTL(LGUI(KC_RGHT))
#define LX_LEFT LCTL(LALT(KC_LEFT))
#define LX_RGHT LCTL(LALT(KC_RGHT))
...
[L_BS] = LAYOUT(
        ...
        U______, SD_MPLY, KC_MPRV, KC_MNXT, TO_BS,   FN_TAB,  KC_LSFT, SY_DEL,  B______,        KC_BSPC, ST_SPC,  SY_GRV,  TO_NV,   _______, _______, _______, _______, B______
),
...
[L_NGRM] = LAYOUT(
        ...
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______
),
[L_MRGN] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
...
[L_NV] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, WN_LEFT, WN_RGHT, _______, _______, _______, B______,        _______, _______, Ct_PGUP, KC_PGDN, KC_PGUP, Ct_PGDN, _______, _______, B______,
        U______, _______, _______, LX_LEFT, LX_RGHT, _______, _______, _______, B______,        _______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,  _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, Ct_HOME, Ct_LEFT, KC_WH_D, KC_WH_U, Ct_RGHT, Ct_END,  _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______
),
[L_LY] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        ...
        U______, TO_LY,   TO_BS,   TO_NV,   TO_FN,   TO_SY,   _______, _______, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______
),
[L_FN] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, B______,        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, B______,
        U______, _______, CT_1,    AT_2,    GT_3,    KC_4,    KC_5,    _______, B______,        _______, KC_6,    KC_7,    GT_8,    AT_9,    CT_0,    _______, _______, B______,
        U______, _______, KC_F11,  KC_F12,  KC_PSCR, KC_CAPS, _______, _______, B______,        _______, KC_MINS, KC_EQL,  KC_BSLS, KC_LBRC, KC_RBRC, _______, _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______
),
[L_SY] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, KC_UNDS, KC_PPLS, KC_PIPE, KC_LCBR, KC_RCBR, _______, _______, B______,
        U______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, B______,        _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_COLN, _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, KC_MINS, KC_EQL,  KC_BSLS, KC_LBRC, KC_RBRC, _______, _______, B______,
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, KC_UNDS, _______, _______, _______, _______, _______, _______, B______
),
// ;: '"
[L_MS] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
...
[L_GAME] = LAYOUT(
        ...
        U______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  KC_LALT, B______,        _______, _______, _______, _______, _______, _______, _______, _______, B______
)
};
