...
// ),
// [L_ISRT] = LAYOUT(
//         U______, _______, KC_Y,    KC_C,    KC_L,    KC_M,    KC_K,    U______, B______,        U______, KC_Z,    KC_F,    KC_U,    KC_COMM, U______, U______, U______, B______,
//         U______, _______, KC_I,    KC_S,    KC_R,    KC_T,    KC_G,    U______, B______,        U______, KC_P,    KC_N,    KC_E,    KC_A,    KC_QUOT, _______, U______, B______,
//         U______, _______, KC_Q,    KC_V,    KC_W,    KC_D,    KC_J,    U______, B______,        U______, KC_B,    KC_H,    KC_SLSH, KC_DOT,  KC_O,    _______, U______, B______,
//         U______, _______, _______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, KC_X,    U______, U______, B______,
//         U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
//         B______, B______, B______, B______, B______, B______, B______, B______, B______,        B______, B______, B______, B______, B______, B______, B______, B______, B______
// ),
