...
[L_BS] = LAYOUT(
        U______, KC_ESC,  KC_Q,    PT_W,    SY_E,    KC_R,    KC_T,    U______, B______,        U______, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    U______, U______, B______,
        U______, KC_ENT,  CT_A,    AT_S,    GT_D,    NV_F,    KC_G,    U______, B______,        U______, KC_H,    NV_J,    GT_K,    AT_L,    CT_SCLN, KC_QUOT, U______, B______,
        U______, TO_PT,   SD_Z,    KC_X,    KC_C,    MS_V,    KC_B,    U______, B______,        U______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, U______, U______, B______,
        U______, U______, U______, U______, U______, NU_TAB,  U______, U______, B______,        U______, U______, SY_GRV,  U______, U______, U______, U______, U______, B______,
...
[L_NGRM] = LAYOUT(
        ...
        U______, U______, U______, U______, U______, _______, U______, U______, B______,        U______, U______, _______, U______, U______, _______, _______, U______, B______,
...
[L_PT] = LAYOUT(
        ...
        U______, _______, _______, U______, U______, _______, U______, U______, B______,        U______, U______, _______, U______, U______, _______, _______, U______, B______,
...
[L_NV] = LAYOUT(
        ...
        U______, _______, KC_LCTL, KC_DEL,  KC_BSPC, _______, _______, U______, B______,        U______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,  U______, B______,
...
[L_SY] = LAYOUT(
        ...
        U______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  U______, U______, B______,        U______, U______, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_DEL,  U______, B______,
...
[L_MS] = LAYOUT(
        ...
        U______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, U______, U______, B______,        U______, U______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, U______, B______,
...
[L_SD] = LAYOUT(
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, U______, _______, KC_MSTP, _______, _______, _______, U______, B______,
        ...
        U______, _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, _______, U______, B______,        U______, U______, KC_MRWD, KC_MUTE, _______, KC_MFFD, _______, U______, B______,
        U______, _______, _______, U______, U______, _______, U______, U______, B______,        U______, U______, _______, U______, U______, _______, _______, U______, B______,
        U______, U______, U______, U______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______,
        B______, B______, B______, B______, B______, B______, B______, B______, B______,        B______, B______, B______, B______, B______, B______, B______, B______, B______
)
