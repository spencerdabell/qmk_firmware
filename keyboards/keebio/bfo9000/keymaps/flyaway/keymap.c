...
_______, LT(_FN,KC_MPLY),KC_MPRV,KC_MNXT,_______,LT(_FN,KC_TAB),LT(_FN,KC_ENT),KC_DEL,_______,       KC_BSPC, LT(_FN,KC_SPC),  KC_TAB,  _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
),
[_FN] = LAYOUT(
