...
_______, _______, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______, _______,       _______, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT , _______,
_______, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______, _______,       _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_END , KC_PGUP,
_______, KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, KC_BSPC, KC_DEL , _______,       KC_ENT , KC_SPC,  KC_BSPC, KC_HOME, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_PGDN
)
};
