...
[L_PT] = LAYOUT(
        ...
        U______, _______, _______, _______, _______, _______, _______, _______, B______,        _______, _______, KC_MINS, KC_PLUS, E______, KC_EQL,  _______, _______, B______,
...
[L_NV] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, WN_LEFT, WN_RGHT, _______, _______, _______, B______,        _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______, B______,
        U______, _______, KC_LCTL, KC_LALT, Ct_PGUP, Ct_PGDN, _______, _______, B______,        _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, B______,
        U______, _______, _______, LX_LEFT, LX_RGHT, _______, _______, _______, B______,        _______, _______, Ct_LEFT, KC_WH_D, KC_WH_U, Ct_RGHT, _______, _______, B______,
        U______, _______, _______, _______, _______, T______, T______, T______, B______,        T______, T______, T______, _______, _______, _______, _______, _______, B______
),
[L_LY] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
