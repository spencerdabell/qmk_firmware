...
_______,LT(_SD,KC_MPLY), KC_MPRV,KC_MNXT,_______,LT(_FN,KC_TAB),ST(KC_ENT),    MO(_SY), _______,        KC_BSPC, ST(KC_SPC),LT(_SY,KC_GRV),_______, TO(_NV), TO(_BS), KC_PSCR, _______, _______
),
[_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, CT(KC_1),AT(KC_2),GT(KC_3),KC_4,    ST(KC_5),_______, _______,                _______, ST(KC_6),KC_7,    GT(KC_8),AT(KC_9),CT(KC_0),_______, _______, _______,
        _______, _______, KC_F11,  KC_F12,  _______, _______, _______, _______, _______,                _______, KC_MINS, KC_EQL,  KC_BSLS, KC_LBRC, KC_RBRC, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[_SY] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_GM] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    _______, _______,        _______, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    _______, _______, _______,
        _______, KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______, _______,        _______, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, _______, _______,
        ...
        _______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  KC_DEL,  _______,        KC_BSPC, KC_SPC,  KC_GRV,  _______, _______, _______, _______, _______, _______
),
[_CK] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, KC_Q,    KC_W,    KC_G,    KC_P,    KC_B,    _______, _______,        _______, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, _______, _______, _______,
        _______, KC_DEL,  KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    _______, _______,        _______, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_BSPC, _______, _______,
        ...
        _______, _______, _______, _______, _______, KC_TAB,  _______, _______, _______,        _______, KC_SPC,  KC_GRV,  _______, _______, _______, _______, _______, _______
)
};
