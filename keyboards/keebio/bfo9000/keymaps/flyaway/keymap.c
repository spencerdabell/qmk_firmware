...
_______, KC_ESC,  CT(KC_A),GT(KC_S),AT(KC_D),ST(KC_F),KC_G,    KC_VOLU, _______,       _______, KC_H, ST(KC_J),AT(KC_K),GT(KC_L),CT(KC_SCLN),KC_QUOT, KC_ENT , KC_PGUP,
_______, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD, _______,       _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP  , KC_PGDN,
_______, KC_LCTL, _______,_______,_______,KC_TAB,LT(_NAV,KC_ENT),KC_DEL,_______,       KC_BSPC, KC_SPC,  KC_TAB,  _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
),
[_NAV] = LAYOUT(
...
_______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______,  _______, _______, _______, _______, _______,
_______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, KC_TAB,  _______, _______, _______, _______, _______, _______, _______
),
[_LY2] = LAYOUT(
_______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______, _______, _______, _______,
_______, _______, _______, _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______, _______, _______, _______,
