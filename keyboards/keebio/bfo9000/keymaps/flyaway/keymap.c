...
[L_BS] = LAYOUT(
        ...
        _______, _______,  _______, _______, _______, _______, _______, _______, _______,       _______,    _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, KC_ESC,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    _______, _______,       _______,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, _______, XXXXXXX,
        _______, KC_DEL,   CT_A,    AT_S,    GT_D,    NV_F,    KC_G,    _______, _______,       _______,    KC_H,    KC_J,    GT_K,    AT_L,    CT_SCLN, KC_QUOT, _______, XXXXXXX,
        _______, TO_BS,    KC_Z,    KC_X,    KC_C,    MS_V,    KC_B,    _______, _______,       _______,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______, _______, XXXXXXX,
        _______, SD_MPLY,  KC_MPRV, KC_MNXT, _______, FN_TAB,  ST_ENT,  SY_DEL,  _______,       KC_BSPC,    ST_SPC,  SY_GRV,  TO_NV,   _______, _______, TO(L_GAME),_______, XXXXXXX
),
[L_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        ...
        _______, _______, KC_F11,  KC_F12,  KC_PSCR, _______, _______, _______, _______,        _______, KC_MINS, KC_EQL,  KC_BSLS, KC_LBRC, KC_RBRC, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX
),
[L_SY] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
...
[L_MS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_ACL2, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_ACL1, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_ACL0, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX
),
[L_SD] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
...
[L_GAME] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  KC_LALT, _______,        _______, _______, _______, _______, _______, _______, TO(L_ENGRAM), _______, XXXXXXX
),
...
[L_ENGRAM] = LAYOUT(
        ...
        _______, _______, CT_C,    AT_I,    GT_E,    NV_A,    _______, _______, _______,        _______, _______, KC_H,    GT_T,    AT_S,    CT_N,    KC_Q,    _______, XXXXXXX,
        _______, _______, KC_G,    KC_X,    KC_J,    MS_K,    _______, _______, _______,        _______, _______, KC_R,    KC_M,    KC_F,    KC_P,    _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, TO(L_CLMK),   _______, XXXXXXX
),
[L_CLMK] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, TO(L_ISRT),_______, XXXXXXX
),
[L_ISRT] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
