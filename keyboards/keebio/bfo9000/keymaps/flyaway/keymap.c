...
[L_BS] = LAYOUT(
        ...
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    U______, B______,        U______, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    TO_BS,   U______, B______,
        U______, KC_ENT,  CT_A,    AT_S,    GT_D,    NV_F,    KC_G,    U______, B______,        U______, KC_H,    NV_J,    GT_K,    AT_L,    CT_SCLN, KC_QUOT, U______, B______,
        U______, TO_PT,   KC_Z,    KC_X,    KC_C,    MS_V,    KC_B,    U______, B______,        U______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  U______, B______,
        U______, SD_MPLY, KC_MPRV, KC_MNXT, U______, NU_TAB,  OSM_SFT, SY_DEL,  B______,        KC_BSPC, ST_SPC,  SY_GRV,  U______, U______, U______, U______, U______, B______
),
...
[L_NGRM] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, KC_B,    KC_Y,    KC_O,    KC_U,    _______, U______, B______,        U______, _______, KC_L,    KC_D,    KC_W,    KC_V,    KC_Z,    U______, B______,
        U______, _______, CT_C,    AT_I,    GT_E,    NV_A,    _______, U______, B______,        U______, _______, KC_H,    GT_T,    AT_S,    CT_N,    _______, U______, B______,
        U______, _______, KC_G,    KC_X,    KC_J,    MS_K,    _______, U______, B______,        U______, _______, KC_R,    KC_M,    KC_F,    KC_P,    KC_Q,    U______, B______,
...
[L_MRGN] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, KC_V,    KC_W,    KC_D,    KC_L,    U______, U______, B______,        U______, U______, KC_U,    KC_O,    KC_Y,    KC_B,    _______, U______, B______,
        U______, KC_Z,    CT_N,    AT_S,    GT_T,    NV_H,    KC_DEL,  U______, B______,        U______, KC_BSPC, KC_A,    GT_E,    AT_I,    CT_C,    _______, U______, B______,
        U______, KC_Q,    KC_P,    KC_F,    KC_M,    MS_R,    U______, U______, B______,        U______, U______, KC_K,    KC_J,    KC_X,    KC_G,    _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
),
[L_CLMK] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
...
[L_PT] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, _______, TO_MRGN, TO_SD,   _______, U______, B______,        U______, _______, KC_COLN, KC_SCLN, KC_DQUO, KC_EXLM, _______, U______, B______,
        U______, _______, TO_SY,   TO_NU,   TO_BS,   TO_NV,   _______, U______, B______,        U______, _______, KC_DOT,  KC_COMM, KC_QUOT, KC_QUES, _______, U______, B______,
        U______, _______, TO_CLMK, TO_ISRT, TO_NGRM, TO_MS,   _______, U______, B______,        U______, _______, KC_MINS, KC_PLUS, _______, KC_EQL,  _______, U______, B______,
...
[L_NV] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, Ct_PGUP, Ct_PGDN, _______, _______, U______, B______,        U______, _______, Ct_PGUP, KC_PGDN, KC_PGUP, Ct_PGDN, _______, U______, B______,
        U______, _______, KC_LCTL, KC_DEL,  KC_BSPC, _______, _______, U______, B______,        U______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, U______, B______,
        U______, _______, _______, DESK_LT, DESK_RT, _______, _______, U______, B______,        U______, _______, Ct_LEFT, KC_WH_D, KC_WH_U, Ct_RGHT, _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
),
[L_NU] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, U______, B______,        U______, _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, U______, B______,
        U______, _______, CT_1,    AT_2,    GT_3,    KC_4,    _______, U______, B______,        U______, _______, KC_7,    GT_8,    AT_9,    CT_0,    KC_DEL,  U______, B______,
        U______, _______, KC_F11,  KC_F12,  KC_F5,   KC_5,    _______, U______, B______,        U______, _______, KC_6,    KC_F6,   KC_CAPS, KC_PSCR, _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
),
[L_SY] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, _______, KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, _______, U______, B______,
        U______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  _______, U______, B______,        U______, _______, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_DEL,  U______, B______,
        U______, _______, _______, _______, _______, KC_PERC, _______, U______, B______,        U______, _______, KC_SLSH, KC_BSLS, E______, KC_PIPE, _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, KC_UNDS, _______, U______, U______, U______, U______, U______, B______
),
[L_MS] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3, _______, U______, B______,
        U______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, _______, U______, B______,        U______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, U______, B______,
        U______, _______, KC_ACL2, KC_ACL1, KC_ACL0, _______, _______, U______, B______,        U______, _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
),
[L_SD] = LAYOUT(
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, U______, U______, U______, U______, U______, U______, U______, B______,        U______, U______, U______, U______, U______, U______, U______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, _______, _______, KC_MSTP, _______, _______, _______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, U______, B______,
        U______, _______, _______, _______, _______, _______, _______, U______, B______,        U______, _______, KC_MRWD, KC_MUTE, _______, KC_MFFD, _______, U______, B______,
        U______, _______, _______, _______, U______, _______, _______, _______, B______,        _______, _______, _______, U______, U______, U______, U______, U______, B______
)
};
