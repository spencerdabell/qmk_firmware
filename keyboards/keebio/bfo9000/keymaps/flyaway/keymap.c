...
_______, KC_LCTL,CTL_T(KC_A),GUI_T(KC_S),ALT_T(KC_D),SFT_T(KC_F),KC_G,KC_VOLU,_______,_______,KC_H,SFT_T(KC_J),ALT_T(KC_K),GUI_T(KC_L),CTL_T(KC_SCLN),KC_QUOT, KC_ENT , KC_PGUP,
