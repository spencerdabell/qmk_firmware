...
[L_BS] = LAYOUT(
        ...
        _______, KC_DEL,   CT_A,    AT_S,    GT_D,    NV_F,    KC_G,    _______, _______,       _______,    KC_H,    KC_J,    GT_K,    AT_L,    CT_SCLN, KC_QUOT, _______, _______,
        _______, TO_BS,    KC_Z,    KC_X,    KC_C,    MS_V,    KC_B,    _______, _______,       _______,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______, _______, _______,
        _______, SD_MPLY,  KC_MPRV, KC_MNXT, _______, FN_TAB,  ST_ENT,  SY_DEL,  _______,       KC_BSPC,    ST_SPC,  SY_GRV,  _______, TO_NV,   TO_BS, TG(L_GAME),_______, _______
),
[L_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, CT_1,    AT_2,    GT_3,    KC_4,    KC_5,    _______, _______,        _______, KC_6,    KC_7,    GT_8,    AT_9,    CT_0,    _______, _______, _______,
...
[L_NV] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, Ct_PGUP, KC_PGDN, KC_PGUP, Ct_PGDN, _______, _______, _______,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, Ct_HOME, Ct_LEFT, KC_WH_D, KC_WH_U, Ct_RGHT, Ct_END,  _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[L_MS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[L_GAME] = LAYOUT(
        ...
        _______, KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______, _______,        _______, KC_H,    KC_LEFT, KC_DOWN, KC_RIGHT,KC_SCLN, _______, _______, _______,
        ...
        _______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  KC_DEL,  _______,        _______, _______, _______, _______, _______, _______, TG(L_CLMK), _______, _______
),
[L_CLMK] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, KC_Q,    KC_W,    KC_G,    KC_P,    KC_B,    _______, _______,        _______, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, _______, _______, _______,
        _______, _______, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    _______, _______,        _______, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    _______, _______, _______,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, TG(L_ISRT),_______, _______
),
[L_ISRT] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, TG(L_HLMK), _______, _______
),
[L_HLMK] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, KC_W,    KC_L,    KC_R,    KC_B,    KC_Z,    _______, _______,        _______, KC_SCLN, KC_Q,    KC_U,    KC_D,    KC_J,    _______, _______, _______,
        _______, _______, KC_S,    KC_H,    KC_N,    KC_T,    KC_COMM, _______, _______,        _______, KC_DOT,  KC_A,    KC_E,    KC_I,    KC_O,    _______, _______, _______,
        _______, _______, KC_F,    KC_M,    KC_V,    KC_C,    KC_SLSH, _______, _______,        _______, KC_G,    KC_P,    KC_X,    KC_K,    KC_Y,    _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, TO_BS,   _______, _______
),
// [L_RSTHD] = LAYOUT(
//         _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
//         _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
//         _______, _______, KC_J,    KC_C,    KC_Y,    KC_F,    KC_K,    _______, _______,        _______, KC_Z,    KC_L,    KC_COMM, KC_U,    KC_Q,    _______, _______, _______,
//         _______, _______, KC_R,    KC_S,    KC_T,    KC_H,    KC_D,    _______, _______,        _______, KC_M,    KC_N,    KC_A,    KC_I,    KC_O,    _______, _______, _______,
//         _______, _______, KC_SLSH, KC_V,    KC_G,    KC_P,    KC_B,    _______, _______,        _______, KC_X,    KC_W,    KC_DOT,  KC_SCLN, KC_ENT,  _______, _______, _______,
//         _______, _______, _______, _______, _______, _______, KC_E,    _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______
// ),
};
