...
[L_BS] = LAYOUT(
        ...
        U_, U______, U______, U______, U______, TO_PT,   OSM_LST, _______, B_,        _______, NU_SPC,  KC_ENT,  U______, U______, U______, U______, U_, B_,
...
[L_PT] = LAYOUT(
        ...
        U_, U______, U______, U______, U______, _______, _______, _______, B_,        _______, ST_UNDS, _______, U______, U______, U______, U______, U_, B_,
        U_, U______, U______, U______, U______, _______, _______, _______, B_,        _______, _______, _______, U______, U______, U______, U______, U_, B_,
        B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_,B_
),
// 
...
[L_NV] = LAYOUT(
        ...
        U_, U______, U______, U______, U______, _______, _______, _______, B_,        _______, KC_TAB,  _______, U______, U______, U______, U______, U_, B_,
        U_, U______, U______, U______, U______, _______, _______, _______, B_,        _______, _______, _______, U______, U______, U______, U______, U_, B_,
        B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_, B_,B_
),
// 
